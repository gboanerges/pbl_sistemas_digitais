...
.EQU sys_lchown, 16 @ change the owner/group of asymbolic link
...
.EQU sys_rename, 38 @ change the name or location of afile
...
.EQU sys_clock_nanosleep, 265 @ high-res sleep with specifiableclock
...
.EQU sys_utimes, 269 @ change file last access and modtimes
.EQU sys_arm_fadvise64_64, 270 @ predeclare access pattern for filedata
...
.EQU sys_mq_timedreceive, 277 @ receive a message from a messagequeue
...
.EQU sys_copy_file_range, 391 @ Copy rng of data frm one file toanother
.EQU sys_preadv2, 392 @ read data into multiple buffers
.EQU sys_pwritev2, 393 @ write data into multiple buffers
.EQU sys_pkey_mprotect, 394 @ set protection on a region ofmemory
